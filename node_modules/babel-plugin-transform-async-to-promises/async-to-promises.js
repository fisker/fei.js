...
;
var helpers;
var alwaysTruthy = ["Object", "Function", "Boolean", "Error", "String", "Number", "Math", "Date", "RegExp", "Array", "Promise"];
            ...
            if (parent.isExpressionStatement() && (targetPath.isAwaitExpression() || targetPath.isYieldExpression()) && processExpressions) {
                ...
                if (targetPath !== test) {
                    ...
                    if (!explicitExits.all) {
                        var consequent = parent.get("consequent");
                        var consequentNode = rewriteAsyncNode(state.generatorState, parent, consequent.node, additionalConstantNames, exitIdentifier);
                        var alternate = parent.get("alternate");
                        var alternateNode = alternate.node ? rewriteAsyncNode(state.generatorState, parent, alternate.node, additionalConstantNames, exitIdentifier) : undefined;
                        var fn = functionize(pluginState, [], blockStatement([types.ifStatement(test.node, consequentNode, alternateNode)]), targetPath);
